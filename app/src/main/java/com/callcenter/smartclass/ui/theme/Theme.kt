package com.callcenter.smartclass.ui.theme
...
private val LightColorPalette = smartclassColors(
    brand = Shadow5,
...
private val DarkColorPalette = smartclassColors(
    brand = Shadow1,
...
fun smartclassTheme(
    ...
    ProvidesmartclassColors(colors) {
        MaterialTheme(
...
object smartclassTheme {
    val colors: smartclassColors
        @Composable
        get() = LocalsmartclassColors.current
}

/**
 * smartclass custom Color Palette
 */
@Immutable
data class smartclassColors(
...
@Composable
fun ProvidesmartclassColors(
    colors: smartclassColors,
    content: @Composable () -> Unit
) {
    CompositionLocalProvider(LocalsmartclassColors provides colors, content = content)
}

private val LocalsmartclassColors = staticCompositionLocalOf<smartclassColors> {
    error("No smartclass ColorPalette provided")
}

/**
 * A Material [Colors] implementation which sets all colors to [debugColor] to discourage usage of
 * [MaterialTheme.colorScheme] in preference to [smartclassTheme.colors].
 */
fun debugColors(
    darkTheme: Boolean,
